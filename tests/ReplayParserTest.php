...
class ReplayParserTest extends \PHPUnit_Framework_TestCase {
	...
	public function replayProvider() {
		return [
			...
			'beta patch 4' => ['0.6.0.14259/0.6.0.14259.SC2Replay', new parser\ressources\Replay(14259, "0.6.0.14259", 46848, "WoL Beta")],
	...
	public function testIdentify() {
		$identiy = parser\ReplayParser::identify(__DIR__.DIRECTORY_SEPARATOR."test_replays".DIRECTORY_SEPARATOR
			."2.1.3.30508".DIRECTORY_SEPARATOR."2.1.3.30508.SC2Replay");
